...
/** 
 * DAO for table "COMMS__TABLE".
*/
public class COMMS_TABLEDao extends AbstractDao<COMMS_TABLE, Long> {

    public static final String TABLENAME = "COMMS__TABLE";

    /**
     * Properties of entity COMMS_TABLE.<br/>
    ...
    public COMMS_TABLEDao(DaoConfig config) {
        super(config);
    }
    
    public COMMS_TABLEDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"COMMS__TABLE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"COMMS__TABLE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, COMMS_TABLE entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, COMMS_TABLE entity) {
        stmt.clearBindings();
    ...
    @Override
    public COMMS_TABLE readEntity(Cursor cursor, int offset) {
        COMMS_TABLE entity = new COMMS_TABLE( //
    ...
    @Override
    public void readEntity(Cursor cursor, COMMS_TABLE entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(COMMS_TABLE entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(COMMS_TABLE entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(COMMS_TABLE entity) {
