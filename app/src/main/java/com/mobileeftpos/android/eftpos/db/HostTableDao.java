...
/** 
 * DAO for table "HOST_TABLE".
*/
public class HostTableDao extends AbstractDao<HostTable, Long> {

    public static final String TABLENAME = "HOST_TABLE";

    /**
     * Properties of entity HostTable.<br/>
    ...
    public HostTableDao(DaoConfig config) {
        super(config);
    }
    
    public HostTableDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"HOST_TABLE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"HOST_TABLE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, HostTable entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, HostTable entity) {
        stmt.clearBindings();
    ...
    @Override
    public HostTable readEntity(Cursor cursor, int offset) {
        HostTable entity = new HostTable( //
    ...
    @Override
    public void readEntity(Cursor cursor, HostTable entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(HostTable entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(HostTable entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(HostTable entity) {
