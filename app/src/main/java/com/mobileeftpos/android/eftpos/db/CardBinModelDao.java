...
/** 
 * DAO for table "CARD_BIN_MODEL".
*/
public class CardBinModelDao extends AbstractDao<CardBinModel, Long> {

    public static final String TABLENAME = "CARD_BIN_MODEL";

    /**
     * Properties of entity CardBinModel.<br/>
    ...
    public CardBinModelDao(DaoConfig config) {
        super(config);
    }
    
    public CardBinModelDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CARD_BIN_MODEL\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CARD_BIN_MODEL\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, CardBinModel entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CardBinModel entity) {
        stmt.clearBindings();
    ...
    @Override
    public CardBinModel readEntity(Cursor cursor, int offset) {
        CardBinModel entity = new CardBinModel( //
    ...
    @Override
    public void readEntity(Cursor cursor, CardBinModel entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(CardBinModel entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(CardBinModel entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(CardBinModel entity) {
