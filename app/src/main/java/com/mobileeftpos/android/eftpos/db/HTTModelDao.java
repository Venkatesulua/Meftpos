...
/** 
 * DAO for table "HTTMODEL".
*/
public class HTTModelDao extends AbstractDao<HTTModel, Long> {

    public static final String TABLENAME = "HTTMODEL";

    /**
     * Properties of entity HTTModel.<br/>
    ...
    public HTTModelDao(DaoConfig config) {
        super(config);
    }
    
    public HTTModelDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"HTTMODEL\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"HTTMODEL\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, HTTModel entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, HTTModel entity) {
        stmt.clearBindings();
    ...
    @Override
    public HTTModel readEntity(Cursor cursor, int offset) {
        HTTModel entity = new HTTModel( //
    ...
    @Override
    public void readEntity(Cursor cursor, HTTModel entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(HTTModel entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(HTTModel entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(HTTModel entity) {
