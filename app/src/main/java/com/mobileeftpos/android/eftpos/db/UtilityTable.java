...
/**
 * Entity mapped to table "UTILITY_TABLE".
 */
@Entity
public class UtilityTable {
    ...
    public UtilityTable(Long id) {
        this.id = id;
    }

    @Generated
    public UtilityTable(Long id, String UTILITY_ID, String ADDITIONAL_PROMPT, String DAILY_SETTLEMENT_FLAG, String LAST_4_DIGIT_PROMPT_FLAG, String INSERT_2_SWIPE, String PIGGYBACK_FLAG, String PINBYPASS, String AUTO_SETTLE_TIME, String LAST_AUTO_SETTLEMENT_DATETIME, String UTRN_PREFIX, String DEFAULT_APPROVAL_CODE) {
        this.id = id;
