...
/** 
 * DAO for table "RECEIPT_TABLE".
*/
public class ReceiptTableDao extends AbstractDao<ReceiptTable, Long> {

    public static final String TABLENAME = "RECEIPT_TABLE";

    /**
     * Properties of entity ReceiptTable.<br/>
    ...
    public ReceiptTableDao(DaoConfig config) {
        super(config);
    }
    
    public ReceiptTableDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"RECEIPT_TABLE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"RECEIPT_TABLE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, ReceiptTable entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ReceiptTable entity) {
        stmt.clearBindings();
    ...
    @Override
    public ReceiptTable readEntity(Cursor cursor, int offset) {
        ReceiptTable entity = new ReceiptTable( //
    ...
    @Override
    public void readEntity(Cursor cursor, ReceiptTable entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(ReceiptTable entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(ReceiptTable entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(ReceiptTable entity) {
