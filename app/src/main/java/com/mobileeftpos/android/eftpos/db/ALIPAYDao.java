...
/** 
 * DAO for table "ALIPAY".
*/
public class ALIPAYDao extends AbstractDao<ALIPAY, Long> {

    public static final String TABLENAME = "ALIPAY";

    /**
     * Properties of entity ALIPAY.<br/>
    ...
    public ALIPAYDao(DaoConfig config) {
        super(config);
    }
    
    public ALIPAYDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ALIPAY\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ALIPAY\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, ALIPAY entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ALIPAY entity) {
        stmt.clearBindings();
    ...
    @Override
    public ALIPAY readEntity(Cursor cursor, int offset) {
    ...
    @Override
    public void readEntity(Cursor cursor, ALIPAY entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(ALIPAY entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(ALIPAY entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(ALIPAY entity) {
