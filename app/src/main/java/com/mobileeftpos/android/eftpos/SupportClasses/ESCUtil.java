...
public class ESCUtil {
	...
	public static byte[] generateMockData() {
		...
		try {
			...
			inPrintBuffer = new String(title, "UTF-8")+new String(nextLine, "UTF-8")+new String(center, "UTF-8")+new String(boldOn, "UTF-8")+new String(fontSize2Big, "UTF-8")+new String(Focus, "UTF-8")+new String(boldOff, "UTF-8")+new String(fontSize2Small, "UTF-8")+
					new String(next2Line, "UTF-8")+new String(left, "UTF-8")+new String(orderSerinum, "UTF-8")+new String(nextLine, "UTF-8")+new String(center, "UTF-8")+new String(boldOn, "UTF-8")+new String(fontSize1Big, "UTF-8")+new String(FocusOrderContent, "UTF-8")+new String(boldOff, "UTF-8")+
					new String(fontSize1Small, "UTF-8")+new String(nextLine, "UTF-8")+new String(left, "UTF-8")+new String(next2Line, "UTF-8")+new String(priceInfo, "UTF-8")+new String(nextLine, "UTF-8")+new String(priceShouldPay, "UTF-8")+new String(next2Line, "UTF-8")+new String(takeTime, "UTF-8")+
					new String(nextLine, "UTF-8")+new String(setOrderTime, "UTF-8")+new String(next2Line, "UTF-8")+new String(center, "UTF-8")+new String(tips_1, "UTF-8")+new String(nextLine, "UTF-8")+new String(center, "UTF-8")+new String(tips_2, "UTF-8")+new String(next4Line, "UTF-8")+
					new String(breakPartial, "UTF-8");
