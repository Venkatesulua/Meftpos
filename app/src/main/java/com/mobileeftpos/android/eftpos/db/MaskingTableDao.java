...
/** 
 * DAO for table "MASKING_TABLE".
*/
public class MaskingTableDao extends AbstractDao<MaskingTable, Long> {

    public static final String TABLENAME = "MASKING_TABLE";

    /**
     * Properties of entity MaskingTable.<br/>
    ...
    public MaskingTableDao(DaoConfig config) {
        super(config);
    }
    
    public MaskingTableDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MASKING_TABLE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MASKING_TABLE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, MaskingTable entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MaskingTable entity) {
        stmt.clearBindings();
    ...
    @Override
    public MaskingTable readEntity(Cursor cursor, int offset) {
        MaskingTable entity = new MaskingTable( //
    ...
    @Override
    public void readEntity(Cursor cursor, MaskingTable entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(MaskingTable entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(MaskingTable entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(MaskingTable entity) {
