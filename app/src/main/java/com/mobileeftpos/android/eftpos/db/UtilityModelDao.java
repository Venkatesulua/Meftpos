...
/** 
 * DAO for table "UTILITY_MODEL".
*/
public class UtilityModelDao extends AbstractDao<UtilityModel, Long> {

    public static final String TABLENAME = "UTILITY_MODEL";

    /**
     * Properties of entity UtilityModel.<br/>
    ...
    public UtilityModelDao(DaoConfig config) {
        super(config);
    }
    
    public UtilityModelDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"UTILITY_MODEL\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"UTILITY_MODEL\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, UtilityModel entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, UtilityModel entity) {
        stmt.clearBindings();
    ...
    @Override
    public UtilityModel readEntity(Cursor cursor, int offset) {
        UtilityModel entity = new UtilityModel( //
    ...
    @Override
    public void readEntity(Cursor cursor, UtilityModel entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(UtilityModel entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(UtilityModel entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(UtilityModel entity) {
