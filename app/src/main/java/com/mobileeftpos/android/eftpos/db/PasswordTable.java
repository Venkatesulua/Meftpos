...
/**
 * Entity mapped to table "PASSWORD_TABLE".
 */
@Entity
public class PasswordTable {
    ...
    public PasswordTable(Long id) {
        this.id = id;
    }

    @Generated
    public PasswordTable(Long id, String PWD_ID, String DEFAULT_PASSWORD, String REFUND_PASWORD, String TIP_ADJUST_PASSWORD, String PRE_AUTH_PASSWORD, String BALANCE_PASSWORD, String OFFLINE_PASSWORD, String SETTLEMENT_PASSWORD, String EDITOR_PASSWORD, String VOID_PASSWORD, String MANUAL_ENTRY_PASSWORD, String CASH_ADVANCED_PASSWORD, String TERMINAL_POWERON_PASSWORD) {
        this.id = id;
        this.PWD_ID = PWD_ID;
