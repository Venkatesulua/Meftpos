...
/** 
 * DAO for table "TRANSACTION_CONTROL_TABLE".
*/
public class TransactionControlTableDao extends AbstractDao<TransactionControlTable, Long> {

    public static final String TABLENAME = "TRANSACTION_CONTROL_TABLE";

    /**
     * Properties of entity TransactionControlTable.<br/>
    ...
    public TransactionControlTableDao(DaoConfig config) {
        super(config);
    }
    
    public TransactionControlTableDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TRANSACTION_CONTROL_TABLE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"TRANSACTION_CONTROL_TABLE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, TransactionControlTable entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, TransactionControlTable entity) {
        stmt.clearBindings();
    ...
    @Override
    public TransactionControlTable readEntity(Cursor cursor, int offset) {
        TransactionControlTable entity = new TransactionControlTable( //
    ...
    @Override
    public void readEntity(Cursor cursor, TransactionControlTable entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(TransactionControlTable entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(TransactionControlTable entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(TransactionControlTable entity) {
