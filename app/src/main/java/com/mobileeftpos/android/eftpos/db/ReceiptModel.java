...
/**
 * Entity mapped to table "RECEIPT_MODEL".
 */
@Entity
public class ReceiptModel {
    ...
    @Generated
    public ReceiptModel(Long id, String RECEIPT_ID, String PRINT_TIMEOUT, String AUTO_PRINT, String PRINTER_INTENSITY_CFG, String PRINTER_CFG) {
        this.id = id;
