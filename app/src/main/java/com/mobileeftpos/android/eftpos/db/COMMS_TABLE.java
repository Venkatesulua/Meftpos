...
/**
 * Entity mapped to table "COMMS__TABLE".
 */
@Entity
public class COMMS_TABLE {

    @Id(autoincrement = true)
    private Long id;
    private String COMMOS_ID;
    private String COM_DESCRIPTION;
    private String COM_PRIMARY_TYPE;
    private String COM_SECONDARY_TYPE;
    private String COM_MODEM_PRIMARY_NUMBER;
    private String COM_MODEM_SECONDARY_NUMBER;
    private String COM_MODEM_STRING;
    private String COM_MODEM_DISABLE_LINE_DETECT;
    private String COM_MODEM_TIMEOUT;
    private String COM_PRIMARY_IP_PORT;
    private String COM_SECONDARY_IP_PORT;
    private String COM_IP_TIMEOUT;
    private String COM_CONNECT_SECONDARY;
    private String COM_SSL_INDEX;
    private String COM_MODEM_INDEX;
    private String COM_PPP_USER_ID;
    private String COM_PPP_PASSWORD;
    private String COM_PPP_MODEM_STRING;
    private String COM_PPP_TIMEOUT;
    ...
    public COMMS_TABLE(Long id) {
        this.id = id;
    }

    @Generated
    public COMMS_TABLE(Long id, String COMMOS_ID, String COM_DESCRIPTION, String COM_PRIMARY_TYPE, String COM_SECONDARY_TYPE, String COM_MODEM_PRIMARY_NUMBER, String COM_MODEM_SECONDARY_NUMBER, String COM_MODEM_STRING, String COM_MODEM_DISABLE_LINE_DETECT, String COM_MODEM_TIMEOUT, String COM_PRIMARY_IP_PORT, String COM_SECONDARY_IP_PORT, String COM_IP_TIMEOUT, String COM_CONNECT_SECONDARY, String COM_SSL_INDEX, String COM_MODEM_INDEX, String COM_PPP_USER_ID, String COM_PPP_PASSWORD, String COM_PPP_MODEM_STRING, String COM_PPP_TIMEOUT) {
        this.id = id;
