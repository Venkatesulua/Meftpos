...
/**
 * Entity mapped to table "CARD_BIN_TABLE".
 */
@Entity
public class CardBinTable {
    ...
    public CardBinTable(Long id) {
        this.id = id;
    }

    @Generated
    public CardBinTable(Long id, String CDT_ID, String CDT_LO_RANGE, String CDT_HI_RANGE, String CDT_HDT_REFERENCE, String CDT_CARD_TYPE_ARRAY, String CDT_CARD_NAME) {
        this.id = id;
        this.CDT_ID = CDT_ID;
