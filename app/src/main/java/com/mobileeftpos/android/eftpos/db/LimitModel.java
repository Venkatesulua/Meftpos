...
/**
 * Entity mapped to table "LIMIT_MODEL".
 */
@Entity
public class LimitModel {
    ...
    public LimitModel(Long id) {
        this.id = id;
    }

    @Generated
    public LimitModel(Long id, String LIMIT_ID, String MAXIMUM_SALE_AMOUNT, String MAXIMUM_OFFLINE_AMOUNT, String MAXIMUM_PREAUTH_AMOUNT, String MAXIMUM_REFUND_AMOUNT) {
        this.id = id;
