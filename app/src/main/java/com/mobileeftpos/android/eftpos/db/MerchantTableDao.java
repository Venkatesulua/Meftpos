...
/** 
 * DAO for table "MERCHANT_TABLE".
*/
public class MerchantTableDao extends AbstractDao<MerchantTable, Long> {

    public static final String TABLENAME = "MERCHANT_TABLE";

    /**
     * Properties of entity MerchantTable.<br/>
    ...
    public MerchantTableDao(DaoConfig config) {
        super(config);
    }
    
    public MerchantTableDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MERCHANT_TABLE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MERCHANT_TABLE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, MerchantTable entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MerchantTable entity) {
        stmt.clearBindings();
    ...
    @Override
    public MerchantTable readEntity(Cursor cursor, int offset) {
        MerchantTable entity = new MerchantTable( //
    ...
    @Override
    public void readEntity(Cursor cursor, MerchantTable entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(MerchantTable entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(MerchantTable entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(MerchantTable entity) {
