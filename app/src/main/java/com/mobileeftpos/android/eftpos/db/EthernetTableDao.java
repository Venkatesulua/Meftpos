...
/** 
 * DAO for table "ETHERNET_TABLE".
*/
public class EthernetTableDao extends AbstractDao<EthernetTable, Long> {

    public static final String TABLENAME = "ETHERNET_TABLE";

    /**
     * Properties of entity EthernetTable.<br/>
    ...
    public EthernetTableDao(DaoConfig config) {
        super(config);
    }
    
    public EthernetTableDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ETHERNET_TABLE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"ETHERNET_TABLE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, EthernetTable entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, EthernetTable entity) {
        stmt.clearBindings();
    ...
    @Override
    public EthernetTable readEntity(Cursor cursor, int offset) {
        EthernetTable entity = new EthernetTable( //
    ...
    @Override
    public void readEntity(Cursor cursor, EthernetTable entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(EthernetTable entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(EthernetTable entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(EthernetTable entity) {
