...
/** 
 * DAO for table "EZLINK_MODEL".
*/
public class EzlinkModelDao extends AbstractDao<EzlinkModel, Long> {

    public static final String TABLENAME = "EZLINK_MODEL";

    /**
     * Properties of entity EzlinkModel.<br/>
    ...
    public EzlinkModelDao(DaoConfig config) {
        super(config);
    }
    
    public EzlinkModelDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"EZLINK_MODEL\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"EZLINK_MODEL\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, EzlinkModel entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, EzlinkModel entity) {
        stmt.clearBindings();
    ...
    @Override
    public EzlinkModel readEntity(Cursor cursor, int offset) {
        EzlinkModel entity = new EzlinkModel( //
    ...
    @Override
    public void readEntity(Cursor cursor, EzlinkModel entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(EzlinkModel entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(EzlinkModel entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(EzlinkModel entity) {
