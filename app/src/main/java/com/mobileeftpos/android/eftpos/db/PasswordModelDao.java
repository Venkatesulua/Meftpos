...
/** 
 * DAO for table "PASSWORD_MODEL".
*/
public class PasswordModelDao extends AbstractDao<PasswordModel, Long> {

    public static final String TABLENAME = "PASSWORD_MODEL";

    /**
     * Properties of entity PasswordModel.<br/>
    ...
    public PasswordModelDao(DaoConfig config) {
        super(config);
    }
    
    public PasswordModelDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PASSWORD_MODEL\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"PASSWORD_MODEL\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, PasswordModel entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, PasswordModel entity) {
        stmt.clearBindings();
    ...
    @Override
    public PasswordModel readEntity(Cursor cursor, int offset) {
        PasswordModel entity = new PasswordModel( //
    ...
    @Override
    public void readEntity(Cursor cursor, PasswordModel entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(PasswordModel entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(PasswordModel entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(PasswordModel entity) {
