...
public class BatchDao extends AbstractDao<Batch, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, Batch entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Batch entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(Batch entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(Batch entity) {
