...
/**
 * Entity mapped to table "TABLE__HTT".
 */
@Entity
public class TABLE_HTT {
    ...
    public TABLE_HTT(Long id) {
        this.id = id;
    }

    @Generated
    public TABLE_HTT(Long id, String HTT_ID, String TRANSMISSION_MODE, String CONNECTION_TIMEOUT, String REDIAL_TIMEOUT, String PABX, String MODEM_STRING, String REPORTTABLE_ID, String DETAILED_REPORT, String TIP_REPORT, String TOTAL_REPORT) {
        this.id = id;
        this.HTT_ID = HTT_ID;
