...
/** 
 * DAO for table "CARD_TYPE_MODEL".
*/
public class CardTypeModelDao extends AbstractDao<CardTypeModel, Long> {

    public static final String TABLENAME = "CARD_TYPE_MODEL";

    /**
     * Properties of entity CardTypeModel.<br/>
    ...
    public CardTypeModelDao(DaoConfig config) {
        super(config);
    }
    
    public CardTypeModelDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"CARD_TYPE_MODEL\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"CARD_TYPE_MODEL\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, CardTypeModel entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, CardTypeModel entity) {
        stmt.clearBindings();
    ...
    @Override
    public CardTypeModel readEntity(Cursor cursor, int offset) {
        CardTypeModel entity = new CardTypeModel( //
    ...
    @Override
    public void readEntity(Cursor cursor, CardTypeModel entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(CardTypeModel entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(CardTypeModel entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(CardTypeModel entity) {
