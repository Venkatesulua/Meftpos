...
/** 
 * DAO for table "LIMIT_TABLE".
*/
public class LimitTableDao extends AbstractDao<LimitTable, Long> {

    public static final String TABLENAME = "LIMIT_TABLE";

    /**
     * Properties of entity LimitTable.<br/>
    ...
    public LimitTableDao(DaoConfig config) {
        super(config);
    }
    
    public LimitTableDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"LIMIT_TABLE\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"LIMIT_TABLE\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, LimitTable entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, LimitTable entity) {
        stmt.clearBindings();
    ...
    @Override
    public LimitTable readEntity(Cursor cursor, int offset) {
        LimitTable entity = new LimitTable( //
    ...
    @Override
    public void readEntity(Cursor cursor, LimitTable entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(LimitTable entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(LimitTable entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(LimitTable entity) {
